...
def macros():
    ...
    # Ensure nutrition section exists
    if "nutrition" not in profile:
        profile["nutrition"] = {"calories": 0, "protein": 0, "fat": 0, "carbs": 0}
        ...
        with col1:
            calories = float(
                st.number_input(
                    ...
                    min_value=0.0,
                    step=1.0,
                    value=float(profile["nutrition"].get("calories", 0)),
                )
            )
        with col2:
            protein = float(
                st.number_input(
                    ...
                    min_value=0.0,
                    step=1.0,
                    value=float(profile["nutrition"].get("protein", 0)),
                )
            )
        with col3:
            fat = float(
                st.number_input(
                    ...
                    min_value=0.0,
                    step=1.0,
                    value=float(profile["nutrition"].get("fat", 0)),
                )
            )
        with col4:
            carbs = float(
                st.number_input(
                    ...
                    min_value=0.0,
                    step=1.0,
                    value=float(profile["nutrition"].get("carbs", 0)),
                )
            )
